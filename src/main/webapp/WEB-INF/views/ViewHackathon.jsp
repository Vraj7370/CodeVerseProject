...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .pill-dark-upcoming  { background: rgba(44,74,110,0.4);  color: #A8C4F0; border: 1px solid rgba(44,74,110,0.6); }
  .pill-dark-ongoing   { background: rgba(45,106,79,0.35); color: #6FCF97; border: 1px solid rgba(45,106,79,0.5); }
  .pill-dark-completed { background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.6); border: 1px solid rgba(255,255,255,0.2); }
  .pill-dark-free      { background: rgba(45,106,79,0.35); color: #6FCF97; border: 1px solid rgba(45,106,79,0.5); }
  .pill-dark-paid      { background: rgba(168,88,88,0.35); color: #EB9090; border: 1px solid rgba(168,88,88,0.5); }
  ...
  .btn-back:hover { background: var(--slate); color: var(--white); }
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <p class="page-subtitle">Full information for this hackathon event</p>
          ...
          <div class="col-lg-10">
            ...
            <div class="detail-card">
              ...
              <div class="detail-card-header">
                ...
                <div class="detail-header-left">
                  ...
                  <div class="detail-header-info">
                    ...
                    <p>ID #${hackathon.hackathonId} &nbsp;·&nbsp; ${hackathon.eventType}</p>
                  </div>
                </div>
              ...
              <div class="detail-body">
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-val">
                      <c:choose>
                        ...
                        <c:otherwise><span class="info-val-muted">Not specified</span></c:otherwise>
                      </c:choose>
                    </div>
                  </div>
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-val">
                      <span class="team-range">
                        👥 <span>${hackathon.minTeamSize}</span> to <span>${hackathon.maxTeamSize}</span> members
                      </span>
                    </div>
                  </div>

                  <div class="info-item">
                    <div class="info-key">User Type</div>
                    <div class="info-val">
                      <c:choose>
                        <c:when test="${not empty hackathon.userTypeId}">${hackathon.userTypeId}</c:when>
                        <c:otherwise><span class="info-val-muted">All users</span></c:otherwise>
                      </c:choose>
                    </div>
                  </div>
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-val">
                      <div class="date-chip">📅 ${hackathon.registrationStartDate}</div>
                    </div>
                  </div>
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-val">
                      <div class="date-chip">📅 ${hackathon.registrationEndDate}</div>
                    </div>
                  </div>
              ...
              <div class="detail-footer">
                <a href="listHackathon" class="btn-action btn-back">← Back to List</a>
                <a href="editHackathon?hackathonId=${hackathon.hackathonId}" class="btn-action btn-edit">✎ Edit Hackathon</a>
              </div>
