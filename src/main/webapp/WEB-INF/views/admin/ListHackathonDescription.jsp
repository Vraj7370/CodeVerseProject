...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Details cell with text wrapping */
  .details-cell {
    max-width: 450px;
    white-space: normal;
    font-size: 0.85rem;
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<p class="page-subtitle">Manage detailed descriptions for each hackathon event</p>
					...
					<div class="form-card">
						...
						<div class="form-card-header">
							...
							<a href="${newDescriptionUrl}" class="btn-new-description">
								+ New Description
							</a>
						</div>
										...
										<tr>
											<td colspan="4">
												<div class="empty-state">
													...
													<p>You haven't added any descriptions for this hackathon yet.</p>
													<c:url var="newEmptyUrl" value="newHackathonDescription">
														<c:if test="${hackathonId != null}">
															<c:param name="hackathonId" value="${hackathonId}" />
														</c:if>
													</c:url>
													<a href="${newEmptyUrl}" class="btn-new-description">+ Create First Description</a>
												</div>
											</td>
										</tr>
									</c:if>
										...
										<tr>
											...
											<td>
												<div class="action-buttons">
													<a href="editHackathonDescription?hackathonDescriptionId=${d.hackathonDescriptionId}" class="cv-btn cv-btn-edit">✏ Edit</a>
													<a href="deleteHackathonDescription?hackathonDescriptionId=${d.hackathonDescriptionId}&hackathonId=${d.hackathonId}" class="cv-btn cv-btn-delete" onclick="return confirm('Are you sure you want to delete this description?')">🗑 Delete</a>
												</div>
											</td>
										</tr>
									</c:forEach>
