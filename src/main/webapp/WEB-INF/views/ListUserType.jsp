  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <p class="page-subtitle">Manage roles and user type classifications</p>
                ...
                <c:forEach var="ut" items="${userTypeList}" varStatus="s">
                  <tr>
                    ...
                    <td style="text-align:center;">
                      <a href="editUserType?userTypeId=${ut.userTypeId}" class="btn-action btn-edit">Edit</a>
                  ...
                  <tr>
                    <td colspan="3">
                      <div class="empty-state">
                        ...
                        <div class="empty-text">No user types found. Add your first one!</div>
                      </div>
                    </td>
                  </tr>
                </c:if>
